...
.setting {
	background: url(${path}/resources/user/fonts/search.svg) no-repeat 2px
		13px;
...
<body>
				...
				<c:if test="${sessionScope.user!=null}">
					<li class="pic_card" id="main_window">
						<div class="piccardDiv">
							...
							<img src="${path}/resources/user/img/bg.png">
							<div class="calendar">
	...
	<script src="${path}/resources/user/js/index1.js"></script>

...
<link rel="stylesheet" href="${path}/resources/admin/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
<!--[if IE 6]>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${path}/resources/admin/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script> 

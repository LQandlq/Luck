...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 评论管理 <span class="c-gray en">&gt;</span>  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">	
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort" style="width: 1294.4px;">
			<thead>
				<tr class="text-c">
...
$(function(){
	$('.table-sort').dataTable({
		...
		ajax : "${path}/admin/getCommentlist?picid="+$('#picid').val(),
		columns: [
			{
		        "data": "checkbox",
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		$.ajax({
			...
			success: function(data){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="member_start(this,id)" data-userid="'+userid+'" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a>');
				$(obj).parents("tr").find(".td-status").html('<span class="label label-defaunt radius">已停用</span>');
				$(obj).remove();
				layer.msg('已禁止!',{icon: 6,time:1000});
			},
			error:function(data) {
		...
		$.ajax({
			...
			url: '/moment/user/update',
			 data:{id:userid,
       		 score:0},
			success: function(data){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" data-userid="'+userid+'" onClick="member_stop(this,id)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>');
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		var id = $(obj).attr('data-commentid');
		$.ajax({
			type: 'POST',
			url: '//localhost:8080/moment/pic/comment/doDelete',
			data:{id:id,
				picid:$('#picid').val()},
			success: function(data){

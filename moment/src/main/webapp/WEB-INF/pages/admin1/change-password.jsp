...
<article class="page-container">
	<form action="${path}/admin/updateUserInfo" method="post" class="form form-horizontal" id="form-change-password">
		<%-- <div class="row cl">
...
<script type="text/javascript" src="${path}/resources/admin/lib/jquery.validation/1.14.0/messages_zh.js"></script> 

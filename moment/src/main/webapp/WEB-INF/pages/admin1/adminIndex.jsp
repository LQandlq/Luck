...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="${path}/admin/adminpic" data-title="作品管理" href="javascript:void(0)">图片管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="${path}/admin/admincategory" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="${path}/admin/adminrepot" data-title="举报反馈" href="javascript:void(0)">举报反馈</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${path}/admin/adminuserlist" data-title="会员列表" href="javascript:;">会员列表</a></li>
					<li><a data-href="${path}/admin/adminuserdelete" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
			</ul>
		</dd>
	</dl>			
</div>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${path}/admin/adminwelcome">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${path}/admin/adminwelcome"></iframe>
	</div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${path}/resources/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
